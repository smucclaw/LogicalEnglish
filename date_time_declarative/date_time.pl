% v0.1.4 of the date_time library for SWI-Prolog.
% Taken from: https://github.com/fnogatz/date_time/blob/ed9b93fab4cc3b45513eb67e7833abd66b886837/prolog/date_time.pl
